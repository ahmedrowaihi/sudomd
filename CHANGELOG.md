...
- Sudomd now collects anonymous usage data to help improve the app, with a clear notice and a Settings toggle to opt out. See [TELEMETRY.md](https://github.com/ahmedrowaihi/sudomd/blob/main/TELEMETRY.md) for what's collected. [#182](https://github.com/ahmedrowaihi/sudomd/pull/182)
