...
description: Use when testing the Sudomd Electron desktop app, especially when inspecting, clicking, screenshotting, or verifying a real note edit in the running app.
---
...
6. When you're done, stop the dev server and confirm no `Sudomd Dev` process remains.
